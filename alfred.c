...
static int compare_entries(const void *a, const void *b)
{
	...
	time_a = mktime((struct tm *)&fa->date);
	time_b = mktime((struct tm *)&fb->date);
...
static int write_log(struct file_entry *entries, int count)
{
	...
	fprintf(fp,
		"Automatically generated by alfred, this log details all "
		"my problem-solving entries and their dates.\n");
